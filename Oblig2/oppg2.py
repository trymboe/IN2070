...
def jpeg(img, q):
    ...
    #Når bilde er transformert sendes transformasjonen og originalen inn til en funksjon som
    #regner på komprisjonsmulighetene
    calculate_space(img, F)
    
    #Når alt er gjort blir bilde iverseres transformasjonen
    f = iDCT(F, qQ)
    img_rev = f+128

    #Det tilbaketransformerte bilde returneres
    return img_rev
